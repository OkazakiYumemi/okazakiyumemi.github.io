...
void ArticleInit(){
    ...
    BasicUrl = "https://www.wenku8.net/novel/" + IntToString(ArticleId / 1000) + "/" + IntToString(ArticleId) + "/";
...
void ArticleDownload(){
    ...
    while(VolumeIterBegin < VolumeIterEnd){
        ...
        while(regex_search(ChapterIterBegin, ChapterIterEnd, ChapterResult, ChapterPattern)){
            ...
            // cout << UrlName << "\n";
            string DownloadUTF8 = "curl -o \".\\" + VolumeName + "\\" + ChapterGet + " utf8.txt\" \"http://dl.wenku8.com/packtxt.php?aid=1213&vid=" + UrlName + "&charset=utf8\"";
            string DownloadGBK = "curl -o \".\\" + VolumeName + "\\" + ChapterGet + " gbk.txt\" \"http://dl.wenku8.com/packtxt.php?aid=1213&vid=" + UrlName + "&charset=gbk\"";
            string DownloadBIG5 = "curl -o \".\\" + VolumeName + "\\" + ChapterGet + " big5.txt\" \"http://dl.wenku8.com/packtxt.php?aid=1213&vid=" + UrlName + "&charset=big5\"";
